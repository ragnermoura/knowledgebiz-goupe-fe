            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">You /</span> Team</h4>
                                ...
                                <table class="table">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        <tr class="text-center" v-for="(atividade, index) in filteredActivities"
                                            ...
                                            <td>{{ atividade.tb_utilizadore.firstname }}</td>
    ...
    methods: {
        searchActivities() {
            const filteredActivities = this.atividades.filter(atividade => {
                const includesQuery = atividade.tb_utilizadore.firstname.toLowerCase().includes(this.searchQuery.toLowerCase());
