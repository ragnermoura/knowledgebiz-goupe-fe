            ...
            <div class="layout-page">
                ...
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="/account-user-stacks"
                        ><i class="bx bx-code me-1"></i> Stacks</a
                      >
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="/account-user-connections"
                    ...
                    <div class="card-body">
                      <form id="formAccountSettings" @submit.prevent="uploadImage">
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            <label for="organization" class="form-label">Education</label>
                            <input
                              type="text"
                              class="form-control"
                              id="organization"
